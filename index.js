...
//Add methods to the `BankBranch` class for managing branch-related information. For example, you can add a method like `getBranchInfo` to retrieve branch details.
    getBranchInfo() {
...
const branchA = new BankBranch("branch FNB");
const branchB = new BankBranch('branch ABSA');
...
console.log(branchA === branchB ? 'Conclusion: Instances are the same':"Conclusion: Intance not the same"); // true, both are the same instance
